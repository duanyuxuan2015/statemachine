 ...
 */
class TransitionBuilderImpl<S extends Enum<S>, E extends Enum<E>,C> extends AbstractTransitionBuilder<S,E,C> implements ExternalTransitionBuilder<S,E,C>, InternalTransitionBuilder<S,E,C> {
